...
//  My Contact List
//
//  Created by Cistudent on 4/18/19.
...
class LocationDemoViewController: UIViewController, CLLocationManagerDelegate {
    ...
    func dismissKeyboard() {
        // Cause the view (or one of its embedded text fields) to resign the first respoder status
    ...
    override func viewDidLoad() {
        ...
        locationManager.requestWhenInUseAuthorization() // Ask for permision to use location
    }
